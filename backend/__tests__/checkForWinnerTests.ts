import checkForWinner, { lineSearch } from './../src/app/utils/checkForWinner';
import { BoardState, Player } from './../src/types';

describe('test line search', () => {
  it('test horizontal lines', () => {
    const board: BoardState = [["X", "X", "X", "X", "X", "-"],
                               ["-", "X", "X", "X", "-", "-"],
                               ["-", "-", "-", "-", "-", "-"],
                               ["-", "-", "-", "-", "-", "-"],
                               ["-", "-", "-", "-", "-", "-"]];
...
describe('test checkForWinner', () => {
  it('test for win', () => {
    const board: BoardState = [["O", "O", "O", "O", "O", "-"],
                               ["-", "O", "O", "O", "-", "-"],
                               ["-", "-", "O", "-", "-", "-"],
                               ["-", "-", "-", "O", "-", "-"],
                               ["-", "-", "-", "-", "-", "-"]];
  ...
  it('test for six in a row', () => {
    const board: BoardState = [["X", "X", "X", "X", "X", "X", "-"],
                               ["-", "X", "X", "X", "-", "-", "-"],
                               ["-", "-", "X", "-", "-", "-", "-"],
                               ["-", "-", "-", "X", "-", "-", "-"],
                               ["-", "-", "-", "-", "-", "-", "-"],
